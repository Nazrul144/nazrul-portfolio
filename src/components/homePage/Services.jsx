          ...
          <Card
            ...
            title={
              <div className="flex items-center justify-between">
                <div>{service.icon}</div> {/* Left Icon */}
                <span className="text-xl">{service.title}</span> {/* Title */} 
                <GoArrowDownRight className="text-2xl  bg-white font-bold border-2 border-gray-500 rounded-full"/>{/* Right Icon */}
              </div>
            }
            variant="borderless"
            style={{ maxWidth: "100%" }}
